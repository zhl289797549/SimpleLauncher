...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.hello.android.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.hello.android.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
